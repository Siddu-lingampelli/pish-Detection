    ...
    <div style={{ background: 'var(--bone)', minHeight: 'calc(100vh - 56px)' }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: 'clamp(24px, 4vw, 40px) clamp(16px, 3vw, 24px)' }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <h1 className="h-display" style={{ fontSize: 'clamp(32px, 5vw, 48px)', margin: 0 }}>Threat analytics</h1>
        </div>

        {/* STAT CARDS */}
        <div className="grid-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 0, border: '1px solid var(--ink)', marginBottom: 24 }}>
          {[
        ...
        {/* CHARTS */}
        <div className="grid-2" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 0, border: '1px solid var(--ink)', marginBottom: 24 }}>
